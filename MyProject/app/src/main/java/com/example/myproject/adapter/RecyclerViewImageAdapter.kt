...
class RecyclerViewImageAdapter(private val dogsImages: ArrayList<String>,private val listener: Listener) : RecyclerView.Adapter<RecyclerViewImageAdapter.RowHolder>(){
    private lateinit var imageView: ImageView

    interface Listener {
        fun onItemClick(breedImage: String)
    }
